...
import me.ste.library.transfer.fabric.slot.FluidContainerFabricItemSlotAdapter
...
class FluidContainerFabricItemAdapter(private val context: ContainerItemContext, private val itemContainer: FluidContainerItem<*>) : FluidContainerFabricAdapter(itemContainer, null) {
    ...
    override fun insert(variant: FluidVariant, maxAmount: Long, transaction: TransactionContext): Long {
        val result = super.insert(variant, maxAmount, transaction)
    ...
    override fun createSlotAdapter(slot: Int) = FluidContainerFabricItemSlotAdapter(this.context, this.itemContainer, slot)
}